 ...
 *
 * Until a real file exists, this renders a soft animated gradient in the
 * same spot so the layout, overlay, and glass treatment can be judged
 * as-is — swapping in the real video changes nothing else.
 */
    ...
    <div className="hero-video-wrap">
      {hasSource && !reduced ? (
        ...
        <div className="hero-video-placeholder" aria-hidden="true">
          ...
          {!hasSource && <span className="hero-video-label mono">ambient loop — placeholder</span>}
        </div>
      )}
